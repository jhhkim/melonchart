$(document).ready(function() {
    ...
    $("#updateBtn").click(function() {
        ...
        // 업데이트를 하기위한 키값
        let id = $("#m_id").val();
        // alert(id + " " + song + " " + songLink + " 수정이 됩니다.");
    ...
    $("#rndBtn").click(function() {
        $.getJSON("/api/v1/playlistrnd", function(result){
            console.log(result.song);
            console.log(result.songLink);
            var html = "오늘의 노래는 <b> " + result.song +" </b> 입니다. <br> 스밍하러 가요~<br>";
            html += '<source src="' + result.songLink + '" class="rounded" alt="' + result.menu + '" width="320" height="240">';
            $("#div1").html(html);
        });
    });  // rndBtn
});
...
function modal_show(id, song, songLink) {
    console.log(id);
    console.log(song);
